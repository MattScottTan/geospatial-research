...
toolbox, and `eip-award/methods/SPATIAL_STATS_ARCGIS_INSTRUCTIONS.md` specifies
"K Nearest Neighbors, K = 8, Row standardization". But the shipped pipeline
(`src/src/pipeline.py`) computes both statistics itself in numpy/scipy, using a
...
Shipped:   gis/cities_with_hotspots.geojson carries gi_star_z / hotspot_class

Usage
-----
    python src/analysis/spatial_diagnostics_esda.py
"""
...
HOTSPOT_GEOJSON = ROOT / "gis" / "cities_with_hotspots.geojson"
