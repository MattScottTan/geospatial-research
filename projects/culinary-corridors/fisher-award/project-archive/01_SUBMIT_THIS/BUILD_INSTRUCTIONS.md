...
[4] Python Software Foundation. (2024). Python Language Reference, version 3.x. https://www.python.org/
...
[7] Pedregosa, F., Varoquaux, G., Gramfort, A., et al. (2011). Scikit-learn: Machine Learning in Python. Journal of Machine Learning Research, 12, 2825–2830. https://jmlr.org/papers/v12/pedregosa11a.html

[8] GeoPy contributors. (2024). GeoPy: Python geocoding and distance toolbox. https://geopy.readthedocs.io/
...
[10] Met Office. (2010–2024). Cartopy: a cartographic Python library with a Matplotlib interface. https://scitools.org.uk/cartopy/

[11] Whitaker, J. (2024). Matplotlib Basemap Toolkit (deprecated; documentation retained). https://matplotlib.org/basemap/stable/users/geography.html

[12] Esri. (2024). ArcGIS Pro and ArcGIS Online. Redlands, CA: Environmental Systems Research Institute. https://www.esri.com/en-us/arcgis/products/arcgis-pro/overview

[13] Patterson, T., & Kelso, N. V. (2024). Natural Earth: Free vector and raster map data (v5.1.1). North American Cartographic Information Society. https://www.naturalearthdata.com/

[14] United Nations Statistics Division. (2021). Standard country or area codes for statistical use (M49). https://unstats.un.org/unsd/methodology/m49/

[15] NOAA National Centers for Environmental Information. (2022). ETOPO 2022 15 Arc-Second Global Relief Model. NOAA NCEI. https://doi.org/10.25921/fd45-gt74

[16] Harvard Center for Geographic Analysis. (2026). Howard Taylor Fisher Prize Award Competition. https://gis.harvard.edu/event/fisher-prize-award-competition
```
...
**7. Bibliography pre-flight.** Section 12 contains 16 numbered references. All 16 URLs were verified as currently resolving on 2026-05-02. Spot-check the corpus citations [1, 2] and the foundational methodology citation [3] are present and correctly formatted before publishing.
