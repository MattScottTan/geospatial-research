# Culinary Corridors — Full StoryMap Script Divided into Copy-Paste Blocks

Use this master file if you want one copy-paste source. Each block also has its own Markdown file in `storymap_section_paste_blocks/`.

**How to use:** paste the material under `PASTE TEXT`, `PASTE CALLOUT`, and `PASTE CAPTION`. Treat `EDITOR NOTE` and `FIGURE INSTRUCTION` as build instructions, not story text.

---

## BLOCK 01: Cover / title / subtitle / author note

**Individual block file:** `storymap_section_paste_blocks/01_cover_title_subtitle_author_note.md`
...
## BLOCK 02: Opening contrast and introduction

**Individual block file:** `storymap_section_paste_blocks/02_opening_contrast_and_introduction.md`
...
## BLOCK 03: Research question and subquestions

**Individual block file:** `storymap_section_paste_blocks/03_research_question_and_subquestions.md`
...
## BLOCK 04: Why food can be treated as spatial data

**Individual block file:** `storymap_section_paste_blocks/04_why_food_can_be_treated_as_spatial_data.md`
...
## BLOCK 05: How the culinary atlas works

**Individual block file:** `storymap_section_paste_blocks/05_how_the_culinary_atlas_works.md`
...
## BLOCK 06: Global discovery screen

**Individual block file:** `storymap_section_paste_blocks/06_global_discovery_screen.md`
...
## BLOCK 07: Finding 1: distance matters, but incompletely

**Individual block file:** `storymap_section_paste_blocks/07_finding_1_distance_matters_but_incompletely.md`
...
## BLOCK 08: Finding 2: residuals reveal candidate culinary corridors

**Individual block file:** `storymap_section_paste_blocks/08_finding_2_residuals_reveal_candidate_culinary_corridors.md`
...
## BLOCK 09: Finding 3: East/Southeast Asia is the strongest focused case

**Individual block file:** `storymap_section_paste_blocks/09_finding_3_east_southeast_asia_is_the_strongest_focused_case.md`
...
## BLOCK 10: Finding 4: terrain, coastlines, islands, and maritime space make the corridor legible

**Individual block file:** `storymap_section_paste_blocks/10_finding_4_terrain_coastlines_islands_and_maritime_space_make.md`
...
## BLOCK 11: Finding 5: residual bridge scores identify spatial bridge roles

**Individual block file:** `storymap_section_paste_blocks/11_finding_5_residual_bridge_scores_identify_spatial_bridge_rol.md`
...
## BLOCK 12: Cuisine-pair vignettes

**Individual block file:** `storymap_section_paste_blocks/12_cuisine_pair_vignettes.md`
...
## BLOCK 13: Secondary / diagnostic case and sensitivity

**Individual block file:** `storymap_section_paste_blocks/13_secondary_diagnostic_case_and_sensitivity.md`
...
## BLOCK 14: What this proves, and what it does not prove

**Individual block file:** `storymap_section_paste_blocks/14_what_this_proves_and_what_it_does_not_prove.md`
...
## BLOCK 15: Sources, methods, and reproducibility

**Individual block file:** `storymap_section_paste_blocks/15_sources_methods_and_reproducibility.md`
...
## BLOCK 16: Conclusion and final contribution

**Individual block file:** `storymap_section_paste_blocks/16_conclusion_and_final_contribution.md`
...
## BLOCK 17: PDF backup / technical report note

**Individual block file:** `storymap_section_paste_blocks/17_pdf_backup_technical_report_note.md`
